...
public class LimitedAgentSecond {
	...
	public LimitedAgentSecond(int steps, double discountFactor, double learningSpeed, int[] memoryAgentActions, int[]  memoryOppActions,
			double confidenceFirst, double confidenceSecond) {
		super();
		setConfidenceLevels(confidenceFirst, confidenceSecond);
	...
	private void setConfidenceLevels(double First, double Second){
		if(First == -1 && Second == -1){ //If all levels are minus one, random initialization
			//TODO: RANDOM CONFIDENCE LEVELS
		} else{
