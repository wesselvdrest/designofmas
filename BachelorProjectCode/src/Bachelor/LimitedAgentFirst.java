...
public class LimitedAgentFirst {
	...
	public LimitedAgentFirst(int steps, double discountFactor, double learningSpeed, int[] memoryAgentActions, int[]  memoryOppActions,
			double confidenceFirst) {
		super();
		setConfidenceLevels(confidenceFirst);
	...
	private void setConfidenceLevels(double First){
		if(First == -1){ //If all levels are minus one, random initialization
